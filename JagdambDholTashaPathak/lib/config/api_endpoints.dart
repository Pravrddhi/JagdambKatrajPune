class ApiEndpoints {
  ...
  // AUTH ENDPOINTS
  // -------------------
  static const String register = '$baseUrl/auth/register/';         // Step 1: Register user (without PIN)
  static const String setPin = '$baseUrl/auth/set-pin/';            // Step 2: Set PIN after registration
